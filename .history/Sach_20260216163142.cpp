...
void traCuuTheoTen(const ListDauSach &ds, const char* tenSach) {
    ...
    while (left <= right) {
        ...
        if (cmp == 0) {
            ...
            cout << "ISBN: " << ds.nodes[mid]->ISBN << "\n";
            cout << "Ten sach: " << ds.nodes[mid]->tenSach << "\n";
            cout << "Tac gia: " << ds.nodes[mid]->tacGia << "\n";
            cout << "The loai: " << ds.nodes[mid]->theLoai << "\n";
            cout << "So trang: " << ds.nodes[mid]->soTrang << "\n";
            cout << "Nam xuat ban: " << ds.nodes[mid]->namXuatBan << "\n";
            cout << "So luot muon: " << ds.nodes[mid]->soLuotMuon << "\n";
            inDanhSachCuonSach(ds.nodes[mid]);
            return;
        } else if (cmp < 0) {
            left = mid + 1;
        } else {
