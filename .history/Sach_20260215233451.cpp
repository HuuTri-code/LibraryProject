...
void themCuonSach(DauSach* dauSach) {
    ...
    if (dauSach->dsSach.pHead == nullptr) {
        ...
        dauSach->dsSach.pTail = newSach; // cập nhật con trỏ pTail của danh sách sách của đầu sách để trỏ đến newSach, vì newSach bây giờ là cuốn sách cuối cùng trong danh sách.
    }
