...
DocGia* taoDocGia(int maThe) {
    ...
    return newDocGia; // trả về con trỏ đến đối tượng DocGia mới được tạo ra, cho phép người gọi có thể sử dụng đối tượng này để thực hiện các thao tác tiếp theo như thêm vào cây hoặc quản lý thông tin của độc giả.
}
