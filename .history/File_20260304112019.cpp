...
{
    ifstream file(filename);    // tạo một đối tượng ifstream có tên là file và mở tệp có tên được chỉ định bởi biến filename để đọc dữ liệu từ tệp đó. Nếu tệp không tồn tại hoặc không thể mở được, đối tượng file sẽ không được khởi tạo thành công, và chúng ta sẽ kiểm tra điều này bằng cách sử dụng phương thức is_open() của đối tượng file để xác định xem tệp đã được mở thành công hay chưa.
