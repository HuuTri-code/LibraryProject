...
struct Sach {
    char maSach[25];   
    int trangThai;     // 0: cho muon duoc, 1: da muon, 2: thanh ly  (Nếu em load dữ liệu từ file thì sao? - khi DocGia* dg = new DocGia;, nó tự động trangThaiThe = THE_HOAT_DONG; --> Nhưng sau đó bạn lại đọc file và gán lại.

→ Việc gán mặc định này thực ra vô nghĩa.)
    char viTri[20];
