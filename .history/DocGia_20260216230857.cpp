...
DocGia* taoDocGia(int maThe) {
    ...
    // Khi thêm một độc giả mới vào cây, con trỏ pRight của nút mới sẽ được gán để trỏ đến nút con bên phải của nút gốc nếu mã thẻ của nút mới lớn hơn mã thẻ của nút gốc, hoặc sẽ được gán để trỏ đến nút con bên trái của nút gốc nếu mã thẻ của nút mới nhỏ hơn mã thẻ của nút gốc. Nếu mã thẻ của nút mới trùng với mã thẻ của nút gốc, việc thêm độc giả mới sẽ thất bại để tránh trùng lặp thông tin.
