...
bool muonSach(TREE_DocGia root, ListDauSach &ds, int maThe, const char* maSach, Ngay ngayMuon) {
    ...
    // tang so luot muon cua dau sach len 1 sau khi co mot cuon sach duoc muon, de theo doi so luot muon cua dau sach do, giup cho viec xep hang top 10 dau sach duoc yeu thich nhat.
    dauSach->soLuotMuon++;
