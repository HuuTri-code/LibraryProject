...
using namespace std;
    ...
    inline void restoreConsole() { // khôi phục lại cấu hình cũ của terminal trước khi thoát chương trình, đảm bảo rằng terminal hoạt động bình thường sau khi chương trình kết thúc.
