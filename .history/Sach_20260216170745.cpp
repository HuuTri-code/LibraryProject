...
void themCuonSach(DauSach* dauSach) {
    ...
    cout << "Nhap ma sach: ";
    cin >> newSach->maSach; // nhập mã sách cho cuốn sách mới thông qua con trỏ newSach. có nghĩa là khi người dùng nhập mã sách, giá trị đó sẽ được lưu vào thành phần maSach của cấu trúc Sach mà newSach đang trỏ tới.
